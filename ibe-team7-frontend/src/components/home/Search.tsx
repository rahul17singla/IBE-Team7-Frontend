...
export function Search() {
  ...
  useEffect(() => {
    const configLoad = async () => {
      try {
        const response = await axios.get("http://localhost:8088/config");
        // console.log(response.data.propertyConfig.first.guests.show);
        setRoomsShow(response.data.propertyConfig.first.rooms.show);
        setShowGuestFeature(response.data.propertyConfig.first.guests.show);
      } catch (error) {
        console.error(error);
      }
    };
          ...
          <div>
                  ...
                  {showGuests && (
                    <div className="guests-dropdown">
                      <div className="guest-counter">
                        <div>
                          <p className="count-title">{t("Adults")}</p>
                          <p className="count-desc">{t("Age")} 18+</p>
                        </div>
                        <div className="counter-section">
                          ...
                          <button className="count-btn">
                            <p className="counter-text">{guestsAdult}</p>
                          </button>
                          <button
                      ...
                      <div className="guest-counter">
                        <div>
                          <p className="count-title">{t("Teens")}</p>
                          <p className="count-desc">{t("Age")} 13-17</p>
                        </div>
                        <div className="counter-section">
                          <button
                          ...
                          <button className="count-btn">
                            <p className="counter-text">{guestsTeens}</p>
                          </button>
                          <button
                      ...
                      <div className="guest-counter">
                        <div>
                          <p className="count-title">{t("Kids")}</p>
                          <p className="count-desc">{t("Age")} 0-12</p>
                        </div>
                        <div className="counter-section">
                          <button
                          ...
                          <button className="count-btn">
                            <p className="counter-text">{guestsChildren}</p>
                          </button>
                          <button
            ...
            {roomsShow && (
              <div className="room-feature">
                        ...
                        <option className="roomOption" value="1">
                            1
                        </option>
                        <option className="roomOption" value="2">
                            2
                        </option>
                        <option className="roomOption" value="3">
                            3
                        </option>
                        <option className="roomOption" value="4">
                            4
                        </option>
                        </select>
              </div>
