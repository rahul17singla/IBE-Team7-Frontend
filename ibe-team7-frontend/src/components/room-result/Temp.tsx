    ...
    return (
        <div>
            <div className="bagimage">
                <img
                    src="public/valeriia-bugaiova-_pPHgeHz1uk-unsplash.jpg"
                    alt=""
                />
            </div>
            ...
            <div className="filter">
                {showGuestFeature && (
                    <div className="result-guest-feature">
                        ...
                        <button
                            ...
                            onClick={() =>
                                reduxDispatch(setShowGuests(!showGuests))
                            }
                        >
                            {guestsAdult + guestsTeens + guestsChildren === 1
                                ? `1  ${t("guest")}`
                                : `${
                                      guestsAdult + guestsTeens + guestsChildren
                                  } ${t("guests")}`}
                        </button>
                ...
                {roomsShow && (
                    <div className="result-room-feature">
                        <label
                            htmlFor="property3"
                            className="result-dropdown-heading-room"
                        >
                            {t("Rooms")}{" "}
                        </label>
                        <select
                ...
                <div className="filteritem4">
                    ...
                    <button
                        ...
                        onClick={() =>
                            reduxDispatch(setShowCalendar(!showCalendar))
                        }
                    >
            ...
            <div className="bottomcontent">
                <div className="bottomfilter">
                    ...
                    <div className="filters">
                        ...
                        {showFilters1 && (
                            <div className="filters-name">Queen Bed</div>
                        )}
                        <hr className="line" />
                    </div>
